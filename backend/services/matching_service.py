...
supplier_chain = get_location_chain(
...
speed_score_value = response_score(
...
def get_candidate_suppliers(
    ...
    exact_rows = (
        ...
        .filter(
            models.SupplierCategory.category_id
            ==
            lead.category_id,

            models.SupplierCategory.subcategory_id
            ==
            lead.subcategory_id
        )
...
for item in top:
    ...
    supplier.auction_base_score = (

        item["score_data"]["final_score"]
    )

    supplier.distance_score = (
        item["score_data"]["distance_score"]
    )

    supplier.reputation_score = (
        item["score_data"]["reputation_score"]
    )

    supplier.speed_score = (
        item["score_data"]["speed_score"]
    )
...
suppliers = get_candidate_suppliers(
